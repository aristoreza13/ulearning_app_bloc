  ...
  return AppBar(
    ...
    bottom: PreferredSize(
      ...
      child: Container(
        ...
        height: 1.0, // defines thickness of line
      ),
    ),
    title: Text(
      "Log In",
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TextField(
            ...
            textInputAction: textType == "password" ? TextInputAction.done : TextInputAction.next,
          ),
        ),
      ],
    ),
...
Widget buildLoginRegisterButton(String buttonName, String buttonType, void Function()? func) {
  return GestureDetector(
    onTap: func,
    child: Container(
      width: 325.w,
