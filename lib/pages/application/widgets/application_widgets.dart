...
Widget buildPage(int index) {
  List<Widget> widget = [
    const HomePage(),
    Center(child: Text("Test Search")),
    Center(child: Text("Test Course")),
    Center(child: Text("Test Chat")),
    const ProfilePage(),
  ];
...
var bottomTabs = [
  ...
  BottomNavigationBarItem(
    label: "chat",
    icon:
        SizedBox(width: 15.w, height: 15.h, child: Image.asset("assets/icons/message-circle.png")),
    activeIcon: SizedBox(
      width: 15.w,
      height: 15.h,
      child: Image.asset(
